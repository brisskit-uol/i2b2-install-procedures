...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/work-cell/build.properties \
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/work-cell/work-ds.xml \
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/work-cell/workplace_application_directory.properties \
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/work-cell/workplace.properties \
...
#====================================
startjboss ${LOG_FILE} "In a browser, use the following URL to verify WorkplaceService is listed as active: ${LIST_SERVICES_URL}"
