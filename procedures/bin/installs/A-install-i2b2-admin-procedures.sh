...
ln -s ${I2B2_INSTALL_DIRECTORY}/i2b2*admin-procedures* i2b2-admin-procedures
ln -s ${I2B2_INSTALL_DIRECTORY}/i2b2*install-procedures* i2b2-install-procedures

#
# Set up the cronjob for periodic uploads of export data to i2b2...
su ${SSH_INTEGRATION_USER}
crontab ${I2B2_INSTALL_PROCS_HOME}/config/cron-params
exit
