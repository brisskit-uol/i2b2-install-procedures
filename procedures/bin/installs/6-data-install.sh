#!/bin/bash
#-----------------------------------------------------------------------------------------------
# Installs i2b2 core hive data plus data for a single demo project. 
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/metadata-db.properties \
             $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Metadata/db.properties 
exit_if_bad $? "Failed to merge properties into $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Metadata/db.properties" $LOG_FILE  
 
cd $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Metadata
$ANT_HOME/bin/ant -f data_build.xml \
                  create_metadata_tables_release_1-7 \
                  >>$LOG_FILE 2>>$LOG_FILE
...
#======================================================
# Install data for 'demo' project (into the crc cell).
#======================================================
print_message "" $LOG_FILE
print_message "About to create data tables, indexes and sequences for 'demo' project within crc cell." $LOG_FILE

#
# Copy config file for 'demo' project
# and merge required substitution values into it... 
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/crcdata-db.properties \
             $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Crcdata/db.properties
exit_if_bad $? "Failed to merge properties into $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Crcdata/db.properties" $LOG_FILE  

cd $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Crcdata
$ANT_HOME/bin/ant -f data_build.xml \
...
# and merge required substitution values into it... 
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/workdata-db.properties \
             $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Workdata/db.properties
exit_if_bad $? "Failed to merge properties into $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Workdata/db.properties" $LOG_FILE  


cd $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Workdata
$ANT_HOME/bin/ant -f data_build.xml \
                  create_workdata_tables_release_1-7 \
                   >>$LOG_FILE 2>>$LOG_FILE
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/hivedata-db.properties \
             $WORK_DIR/data/edu.harvard.i2b2.data/Release_1-7/NewInstall/Hivedata/db.properties     
exit_if_bad $? "Failed to merge properties into $WORK_DIR/data/edu.harvard.i2b2.data/Release_1-7/NewInstall/Hivedata/db.properties" $LOG_FILE  

cd $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Hivedata
$ANT_HOME/bin/ant -f data_build.xml \
                  create_hivedata_tables_release_1-7 \
                  >>$LOG_FILE 2>>$LOG_FILE
...
#
# Update hive data inserts with BRISSKIT specific i2b2 domain information and others...
NEWINSTALL=$WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/sql/crc_db_lookup_${DB_TYPE}_insert_data.sql \
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/sql/ont_db_lookup_${DB_TYPE}_insert_data.sql \
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/sql/work_db_lookup_${DB_TYPE}_insert_data.sql \
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/sql/im_db_lookup_${DB_TYPE}_insert_data.sql \
             $NEWINSTALL/Hivedata/scripts/im_db_lookup_${DB_TYPE}_insert_data.sql
exit_if_bad $? "Failed to merge properties into $NEWINSTALL/Hivedata/scripts/im_db_lookup_${DB_TYPE}_insert_data.sql" $LOG_FILE 
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
            $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/pmdata-db.properties \
            $WORK_DIR/data/edu.harvard.i2b2.data/Release_1-7/NewInstall/Pmdata/db.properties   
exit_if_bad $? "Failed to merge properties into $WORK_DIR/data/edu.harvard.i2b2.data/Release_1-7/NewInstall/Pmdata/db.properties" $LOG_FILE  

#
# Update pm data inserts with BRISSKIT specific information... 
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/sql/create_${DB_TYPE}_i2b2pm_tables.sql \
             $NEWINSTALL/Pmdata/scripts/create_${DB_TYPE}_i2b2pm_tables.sql
exit_if_bad $? "Failed to merge properties into $NEWINSTALL/Pmdata/scripts/create_${DB_TYPE}_i2b2pm_tables.sql" $LOG_FILE

cd $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Pmdata
$ANT_HOME/bin/ant -f data_build.xml \
                  create_pmdata_tables_release_1-7 \
                  >>$LOG_FILE 2>>$LOG_FILE
...
# Update pm data inserts with BRISSKIT specific information... 
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/sql/pm_access_insert_data.sql \
...
#==========================================
# Install Imdata for 'demo' project
#==========================================
print_message "" $LOG_FILE
print_message "About to create imdata tables, indexes and sequences for 'demo' project." $LOG_FILE
#
# Copying config file for 'demo' project
# and merge required substitution values into it... 
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/data/imdata-db.properties \
             $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Imdata/db.properties
exit_if_bad $? "Failed to merge properties into $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Imdata/db.properties" $LOG_FILE  


cd $WORK_DIR/$DATA_DIRECTORY/edu.harvard.i2b2.data/Release_1-7/NewInstall/Imdata
$ANT_HOME/bin/ant -f data_build.xml \
                  create_imdata_tables_release_1-7 \
                   >>$LOG_FILE 2>>$LOG_FILE
exit_if_bad $? "Failed to create imdata tables, indexes and sequences for 'demo' project." $LOG_FILE
print_message "Success! Created imdata tables, indexes and sequences for 'demo' project." $LOG_FILE

#
# Load the data.
print_message ""
print_message "About to load the imdata for 'demo' project. This will take some minutes."
$ANT_HOME/bin/ant -f data_build.xml \
                  db_imdata_load_data  \
                  >>$LOG_FILE 2>>$LOG_FILE
exit_if_bad $? "Failed to load imdata for 'demo' project." $LOG_FILE
print_message "Success! Imdata for 'demo' project loaded successfully." $LOG_FILE
