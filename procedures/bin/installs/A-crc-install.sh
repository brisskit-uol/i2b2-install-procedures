...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/crc-cell/edu.harvard.i2b2.crc.loader.properties \
             $WORK_DIR/$SOURCE_DIRECTORY/edu.harvard.i2b2.crc/etc/spring/edu.harvard.i2b2.crc.loader.properties
exit_if_bad $? "Failed to merge properties into $WORK_DIR/$SOURCE_DIRECTORY/edu.harvard.i2b2.crc/etc/spring/edu.harvard.i2b2.crc.loader.properties" $LOG_FILE

merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/crc-cell/CRCLoaderApplicationContext.xml \
             $WORK_DIR/$SOURCE_DIRECTORY/edu.harvard.i2b2.crc/etc/spring/CRCLoaderApplicationContext.xml
exit_if_bad $? "Failed to merge properties into $WORK_DIR/$SOURCE_DIRECTORY/edu.harvard.i2b2.crc/etc/spring/CRCLoaderApplicationContext.xml" $LOG_FILE

merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/crc-cell/build.properties \
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/crc-cell/crc_application_directory.properties \
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/crc-cell/crc.properties \
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/crc-cell/CRCApplicationContext.xml \
...
merge_config $I2B2_INSTALL_PROCS_HOME/config/config.properties \
             $I2B2_INSTALL_PROCS_HOME/merge-files/$DB_TYPE/crc-cell/crc-ds.xml \
...
#====================================
startjboss ${LOG_FILE} "In a browser, use the following URL to verify QueryToolService is listed as active: ${LIST_SERVICES_URL}"
